...
const TodoInterface = ({ setIsAuthenticated }) => {
    ...
    return (
        <>
            <div className="min-h-screen bg-white pb-32 flex">
            ...
            <div className={`fixed bottom-16 left-1/2 transform -translate-x-1/2 w-[90%] sm:w-auto sm:min-w-[400px] sm:max-w-[500px] transition-all duration-300 ease-in-out ${isModalOpen ? 'opacity-0 translate-y-4 pointer-events-none' : 'opacity-100 translate-y-0'}`}>
                <button
                ...
                >
                    ...
                    <span className="text-gray-400"><ArrowBigRightDashIcon size={20} /></span>
                </button>
            </div>
