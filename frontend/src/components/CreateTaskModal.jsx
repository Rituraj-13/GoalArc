                                ...
                                <div className="p-4">
                                    ...
                                    <div className={cn(
                                        ...
                                        <input
                                            ...
                                            className={cn(
                                                "w-full px-4 py-3 text-lg focus:outline-none rounded-t-xl",
                                    ...
                                    <button
                                        type="submit"
                                        className={cn(
                                            "w-full py-3 rounded-lg transition-all transform hover:scale-[1.02] font-semibold shadow-md",
                                            isDark
